...
import Content from '@/components/chatbot/sidebar/components/Content';
import {
  renderThumb,
  renderTrack,
  renderView,
} from '@/components/chatbot/scrollbar/Scrollbar';
...
export function SidebarResponsive(props: { routes: IRoute[] }) {
  ...
  const { routes } = props;
  return (
    <Flex display={{ sm: 'flex', xl: 'none' }} border="1px solid red" alignItems="center">
